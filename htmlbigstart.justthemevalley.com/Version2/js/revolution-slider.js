            ...
            var h, u, p, c, f, g, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                Q = function() {
                    var t = N.indexOf("Android"),
                        e = W("a");
                    return p = -1 !== N.indexOf("Safari") && -1 === N.indexOf("Chrome") && (-1 === t || Number(N.substr(t + 8, 1)) > 3), f = p && 6 > Number(N.substr(N.indexOf("Version/index.html") + 8, 1)), c = -1 !== N.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(N) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(N)) && (g = parseFloat(RegExp.$1)), e ? (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity)) : !1
                }(),
                X = function(t) {
...
if (1 == window.tplogs) try {
    ...
    var a = i.is_mobile(),
        ...
        b = function(t, e) {
            var i = t.split("/"),
                a = e.split("https://htmlbigstart.justthemevalley.com/");
            i.pop();
            for (var n = 0; n < a.length; n++) "." != a[n] && (".." == a[n] ? i.pop() : i.push(a[n]));
            return i.join("https://htmlbigstart.justthemevalley.com/")
        },
        x = function(e, i, a) {
